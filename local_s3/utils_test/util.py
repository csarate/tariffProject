...
def MonthDict():
    dict = \
        {'enero': 'January', 'Enero': 'January', 'ENERO': 'January', 'ene': 'January',
         'febrero': 'February', 'FEBRERO': 'February', 'Febrero': 'February', 'feb': 'February',
         'marzo': 'March', 'MARZO': 'March', 'Marzo': 'March', 'mar': 'March',
         'abril': 'April', 'ABRIL': 'April', 'Abril': 'April', 'abr': 'April',
         'mayo': 'May', 'MAYO': 'May', 'Mayo': 'May', 'may': 'May',
         'junio': 'June', 'JUNIO': 'June', 'Junio': 'June', 'jun': 'June',
         'julio': 'July', 'JULIO': 'July', 'Julio': 'July', 'jul': 'July',
         'agosto': 'August', 'AGOSTO': 'August', 'Agpsto': 'August', 'ago': 'August',
         'septiembre': 'September', 'SEPTIEMBRE': 'September', 'Septiembre': 'September', 'sep': 'September',
         'octubre': 'October', 'OCTUBRE': 'October', 'Octubre': 'October', 'oct': 'October',
         'noviembre': 'November', 'NOVIEMBRE': 'November', 'Noviembre': 'November', 'nov': 'November',
         'diciembre': 'December', 'DICIEMBRE': 'December', 'Diciembre': 'December', 'dic': 'December'}
    return dict
