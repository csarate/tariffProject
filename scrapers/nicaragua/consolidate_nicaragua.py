...
def consolidate_tariff(time_to_search, status_file, event: dict, local):
    ...
    while time.time() - beginning_time < time_to_search:
        ...
        try:
            ...
            util.tariff_to_xlsx(date + "chunk " + str(chunk) + "_nicaragua_tariff_db", DS_IDB, local)
            ...
            msg = "Ended with the consolidate of the chunk " + str(
                chunk) + " Nicaragua tariff tables. Execution time = " + str(
        ...
        if chunk == len(arq_chunk) - 1:
            ...
            util.tariff_to_xlsx(date + "nicaragua_tariff_db", DS_IDB_Result, local)
            ...
            msg = 'Ended with the consolidation of Nicaragua tariff tables'
            util.log(local, msg)
