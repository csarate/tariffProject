...
def consolidate_tariff(status_file, event: dict, local):
    ...
    while not util.execution_time_out():
        ...
        try:
            ...
            util.tariff_to_xlsx(date + "chunk " + str(chunk) + "_panama_tariff_db", DS_IDB, local)
            ...
            msg = "Ended with the consolidate of the chunk " + str(
                chunk) + " Panama tariff tables. Execution time = " + str(
        ...
        if chunk == len(arq_chunk) - 1:
            ...
            util.tariff_to_xlsx(date + "panama_tariff_db", DS_IDB_Result, local)
            ...
            msg = 'Ended with the consolidation of Panama tariff tables'
            util.log(local, msg)
